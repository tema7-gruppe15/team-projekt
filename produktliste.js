...
//                 <h2 class="h2produktliste">${product.name}</h2>
//                 <p class="pproduktliste"><strong>Mealtype:</strong> ${product.mealType.join(", ")}</p>
//                 <p class="pproduktliste"><strong>Servings:</strong> ${product.servings}</p>
//                 <p class="pproduktliste"><strong>Calories per serving:</strong> ${product.caloriesPerServing}</p>
//                 <p class="pproduktliste"><strong>Difficulty:</strong> ${product.difficulty}</p>

//                 <div class="rating">
//                     <p><strong>Rating:</strong> ${product.rating}</p>
//                     <p><strong>Reviews:</strong> ${product.reviewCount}</p>
//                 </div>
//                 <a class="read" href="produkt.html?id=${product.id}">Read more</a>
//             </div>`
//     )
//     .join(``);
...
//   let selectedValue = this.value; // Henter den valgte værdi
//   if (selectedValue !== "All") {
//     window.location.href = `produktliste.html?category=${selectedValue}`; // Omdirigerer til URL med valgt kategori
//   } else {
//     window.location.href = "produktliste.html"; // Går til 'All' siden
//   }
// });
